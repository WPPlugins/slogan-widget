...
/*
  ...
  Copyright 2016  Tobias Gafner  (email : support@gnetos.de)
...
function qs_slogantime_type_styling_function($post) {
	...
	?>
	<p><?php echo __("Month").'.'.__("Year"); ?> (mm.yyyy): <input type="text" value="<?php echo $slogantime; ?>" autocomplete="off" size="7" maxlength="7" class="form-input-tip" name="slogantime" id="slogantime"></p>
	<?php
}
...
function qs_sloganscripture_type_styling_function($post) {
	...
	?>
	<p><input type="text" value="<?php echo $sloganscripture; ?>" autocomplete="on" size="30" class="form-input-tip" name="sloganscripture" id="new-tag-sloganscripture">
	</p>
	<?php
}
...
class QSSloganSidebarWidget extends WP_Widget {
    ...
    <p>
    	...
    	<select name="<?php echo $this->get_field_name('slogancategory'); ?>"' id="<?php echo $this->get_field_id('slogancategory'); ?>">
			<option value="monatsspruch" <?php if($slogancategory == "monatsspruch") echo "selected"; ?>><?php echo __(QS_TYPE_MONTH); ?></option>
			<option value="jahresspruch" <?php if($slogancategory == "jahresspruch") echo "selected"; ?>><?php echo __(QS_TYPE_YEAR); ?></option>
		</select>
  	</p>
...
$contentResult = str_replace( '[_SLOGAN-MONTH_]' , $sloganMonth , $contentResult);
